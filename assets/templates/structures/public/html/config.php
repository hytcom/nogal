...
// directorio project
define("NGL_PATH_PROJECT",														NGL_DOCUMENT_ROOT."/html");

// directorio public
define("NGL_PATH_PUBLIC",														NGL_PATH_PROJECT);

// directorio rind cache
define("NGL_PATH_CACHE",														NGL_PATH_PROJECT."/<{=NOGALDIRS=}>/cache");

// configuraciones
define("NGL_PATH_CONF",															NGL_PATH_PROJECT."/<{=NOGALDIRS=}>/conf");

// repositorio de datos
define("NGL_PATH_DATA",															NGL_PATH_PROJECT."/<{=NOGALDIRS=}>/data");
...
// carpeta de logs
define("NGL_PATH_LOGS",															NGL_PATH_PROJECT."/<{=NOGALDIRS=}>/logs");

// carpeta temporal
define("NGL_PATH_TMP",															NGL_PATH_PROJECT."/<{=NOGALDIRS=}>/tmp");

// contenedor de operaciones con archivos
define("NGL_SANDBOX",														    NGL_PATH_PROJECT."/<{=NOGALDIRS=}>");
...
define("NGL_PATH_TUTORS",														NGL_PATH_PROJECT."/<{=NOGALDIRS=}>/tutors");

// nuts
define("NGL_PATH_NUTS",															NGL_PATH_PROJECT."/<{=NOGALDIRS=}>/nuts");
...
// define("NGL_FONT", 															NGL_PATH_FRAMEWORK."/roboto.ttf");
