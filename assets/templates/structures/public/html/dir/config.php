...
define("NGL_PROJECT_SETTINGS",													__DIR__."/settings.php");
...
define("NGL_PATH_CROWN",														NGL_PATH_GARDEN);

// tutores
define("NGL_PATH_TUTORS",														NGL_PATH_GARDEN."/<{=NOGALDIRS=}>/tutors");

// nuts
define("NGL_PATH_NUTS",															NGL_PATH_GARDEN."/<{=NOGALDIRS=}>/nuts");

// project grafts (third-party)
define("NGL_PATH_GRAFTS",														NGL_PATH_GARDEN."/<{=NOGALDIRS=}>/grafts");

// directorio rind cache
define("NGL_PATH_CACHE",														NGL_PATH_GARDEN."/<{=NOGALDIRS=}>/ground/cache");

// configuraciones
define("NGL_PATH_CONF",															NGL_PATH_GARDEN."/<{=NOGALDIRS=}>/ground/conf");

// repositorio de datos
define("NGL_PATH_DATA",															NGL_PATH_GARDEN."/<{=NOGALDIRS=}>/ground/data");

// repositorio de sesiones para los modos fs o sqlite
define("NGL_PATH_SESSIONS",														NGL_PATH_GARDEN."/<{=NOGALDIRS=}>/ground/sessions");

// carpeta de logs
define("NGL_PATH_LOGS",															NGL_PATH_GARDEN."/<{=NOGALDIRS=}>/ground/logs");

// carpeta temporal
define("NGL_PATH_TMP",															NGL_PATH_GARDEN."/<{=NOGALDIRS=}>/ground/tmp");

// contenedor de operaciones con archivos
define("NGL_SANDBOX",															NGL_PATH_GARDEN."/<{=NOGALDIRS=}>");

// directorio public
define("NGL_PATH_PUBLIC",														NGL_PATH_GARDEN);
