...
if(defined("NGL_GARDENER_JOURNAL") && !NGL_GARDENER_JOURNAL) { $ngl()->errorHTTP(418); }

if(!is_dir(NGL_PATH_FRAMEWORK)) { gardenerError("NGL_PATH_FRAMEWORK no es una ruta válida: ".NGL_PATH_FRAMEWORK); }
if(!is_dir(NGL_PATH_GARDEN)) { gardenerError("NGL_PATH_GARDEN no es una ruta válida: ".NGL_PATH_GARDEN); }
