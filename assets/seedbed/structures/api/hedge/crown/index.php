	...
	<body>
		<div class="container">
			...
			<table class="class table table-striped table-bordered">
				<tr class="class-head">
					<th width="30%" class="class-head-cell">API</th>
					<td class="class-cell">
						<ul>
							<li><a href="/api/object/get" target="_blank">FROM OBJECT GET</a></li>
							<li><a href="/api/object/get/u02" target="_blank">FROM OBJECT GET BY ID</a></li>
							<li><a href="/api/lambda/get" target="_blank">FROM LAMBDA</a></li>
							<li><a href="/api/nut/json?url=https://cdn.upps.cloud/json/postas_vacunacion_covid.geojson&claim=features&format=json" target="_blank">FROM NUT WITH ARGUMENTS</a></li>
					</td>
				</tr>
				<tr class="class-head">
